    ...
    internal static class HttpExtensions
    {
        ...
        internal static void AddInternal(WebHeaderCollection headers, string key, string value)
        {
            ...
            if (_addInternalMethod == null)
            {
                ...
                var mi = typeof(WebHeaderCollection).GetMethod(internalMethodName,BindingFlags.NonPublic | BindingFlags.Instance,null,new Type[] { typeof(string), typeof(string) },null);
